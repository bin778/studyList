        ...
        <div className="regist-layer">
            ...
            <div className="card">
                ...
                <div className="in-name">
                    <InputBox type="text" guide="성(姓)" />
                    <InputBox type="text" guide="이름(성은 제외)" />
                </div>
                {/* 휴대폰 및 비밀번호 폼 */}
                <div className="in-info">
                    <InputBox type="text" guide="휴대폰 번호 또는 이메일" />
                    <InputBox type="password" guide="새 비밀번호" />
                </div>
                {/* 생년월일 */}
                <div className="in-age">
                    ...
                    <div>
                        ...
                        <select id="month" placeholder="월" name="birthday_month" title="월">
                            <option value="1" selected="1">1월</option>
                ...
                <div className="in-type">
                    ...
                    <div className="regist">
                        <button type="submit" name="websubmit" onclick="regist()">가입하기</button>
                    </div>
                    {/* 로그인 페이지 이동 */}
                    <div className="login">
                        <a onClick={() => window.location.href = "/login"} >이미 계정이 있으신가요?</a>
                    </div>
                </div>
            </div>
        </div>
