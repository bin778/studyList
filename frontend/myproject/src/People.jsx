                ...
                <div className="t-layer">
                    ...
                    <div className="t-navi">
                        <div className="tr">
                            ...
                            <LabelBox id={2} active={active} title="토론" onClick={()=>{setActive(2)}} />
                            <LabelBox id={3} active={active} title="추천" onClick={()=>{setActive(3)}} />
                            <LabelBox id={4} active={active} title="주제" onClick={()=>{setActive(4)}} />
                            <LabelBox id={5} active={active} title="사람" onClick={()=>{setActive(5)}} />
                            <LabelBox id={6} active={active} title="이벤트" onClick={()=>{setActive(6)}} />
                            <LabelBox id={7} active={active} title="미디어" onClick={()=>{setActive(7)}} />
