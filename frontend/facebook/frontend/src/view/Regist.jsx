...
export default function Regist(props) {
  ...
  const onClickRegist = () => {
    ...
    if (!email.match(regExp)) {
      return alert("이메일 형식과 맞지 않습니다. 이메일을 다시 확인해주세요");
    }

    const params = { userid, email, password, year, month, day, gender };
    ...
    <div className="regist-layer">
      ...
      <div className="card">
        ...
        <div className="body">
          ...
          {/* 가입하기 버튼 */}
          <div className="regist" onClick={onClickRegist}>
            <Button type="secondary" text="가입하기" />
          </div>
          {/* 로그인 페이지 이동 */}
          <div className="login">
